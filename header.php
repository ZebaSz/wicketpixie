...
<head profile="http://gmpg.org/xfn/11">
	...
	<?php endif; ?></title>
	<?php $time = time(); ?>
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/min/reset.css?<?php echo $time; ?>" type="text/css" media="screen, projection" />
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/min/screen.css?<?php echo $time; ?>" type="text/css" media="screen, projection" />
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/min/print.css?<?php echo $time; ?>" type="text/css" media="print" />
	<!--[if lte IE 8]><link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/min/ie.css?<?php echo $time; ?>" type="text/css" media="screen, projection" /><![endif]-->
	...
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/min/loader.css?<?php echo time(); ?>" type="text/css" media="all" />
	<?php endif;
	ob_flush();
	flush(); ?>
