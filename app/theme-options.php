...
// Function called to output option if set, else output option default
function wicketpixie_get_option($option) {
	global $theme_options;
	return (get_option('wicketpixie_theme_'.$option)) ? get_option('wicketpixie_theme_'.$option) : $theme_options[$option]['std'];
}
// Output settings
...
function wicketpixie_theme_print_options() { ?>
	<style type='text/css'>
		...
		#content a:link, #content a:visited, #content a:active, #content .comment h3 a:link, #content .comment h3 a:active, #content .comment h3 a:visited {color: <?php echo wicketpixie_get_option('content_links_color'); ?>;}
		...
		#mid h1, #mid h2, #mid h3, #mid h4, #mid h5, #mid h6, #mid h1 a:link, #mid h1 a:visited, #mid h1 a:active, #mid h2 a:link, #mid h2 a:visited, #mid h2 a:active, #mid h3 a:link, #mid h3 a:visited, #mid h3 a:active, #mid h4 a:link, #mid h4 a:visited, #mid h4 a:active, #mid h5 a:link, #mid h5 a:visited, #mid h5 a:active, #mid h6 a:link, #mid h6 a:visited, #mid h6 a:active {color: <?php echo wicketpixie_get_option('titles_color'); ?>;}
		#mid #sidebar a:link, #mid #sidebar a:visited, #mid #sidebar a:active {color: <?php echo wicketpixie_get_option('sidebar_links_color'); ?>;}
		#mid a:hover, #mid h1 a:hover, #mid h2 a:hover, #mid h3 a:hover, #mid h4 a:hover, #mid h5 a:hover, #mid h6 a:hover, #mid #sidebar a:hover, #mid #sidebar h1 a:hover, #mid #sidebar h2 a:hover, #mid #sidebar h3 a:hover, #mid #sidebar h4 a:hover, #mid #sidebar h5 a:hover, #mid #sidebar h6 a:hover, #content .comment h3 a:hover {color: #000;border-bottom: 1px solid <?php echo wicketpixie_get_option('content_links_color'); ?>;}
		#mid #sidebar h1, #mid #sidebar h2, #mid #sidebar h3, #mid #sidebar h3 a:link, #mid #sidebar h3 a:visited, #mid #sidebar h3 a:active, #mid #sidebar h4, #mid #sidebar h5, #mid #sidebar h6 {color: <?php echo wicketpixie_get_option('sidebar_headings_color'); ?>;}
	</style>
<?php } ?>
