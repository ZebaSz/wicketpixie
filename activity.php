...
$sources->archive_streams(); ?>
			...
			<div id="content">
				...
				<div class="page">
					...
					<!-- activity -->
					<div id="activity">
						<?php $page = (isset($_GET['page']) && ($_GET['page'] > 0)) ? intval($_GET['page']) : 1;
						$results = array_chunk($sources->show_streams(),50,true);
						...
						$source_data = $sources->source($stream->name);
