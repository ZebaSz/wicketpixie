...
by ZebaSz at http://zeblog.com.ar/
...
This theme was designed for (and requires) WordPress 3.4+ and PHP5. However,
we recommend that you use the latest versions available. At the time of writing,
the latest WordPress is 3.4 and the latest PHP is 5.4.4.
...
the "backgrounds" folder is not necessary nor useful.
